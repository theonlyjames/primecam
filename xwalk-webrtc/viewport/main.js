...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var connectBtn = document.querySelector('#connect'); var recipientIdEntry = document.querySelector('#recipient-id');
    ...
    var sendData;
    var initDataConn = function(id) {
        //var cameraId = 'cam';
        dataConnection = peer.connect(id, {serialization: "json"});
        dataConnection.serialization = "json";

        dataConnection.on('open', function () {
            console.log('data connection open: ' + id);
            messageBox.innerHTML = "Connection Open";

            dataConnection.on('data', function (data) {
                console.log('recieved data: ', data);
                messageBox.innerHTML = "FUCK YEA";
            });

            sendData = function () {
                dataConnection.send('Hi from view');
            };
        });
    ...
    test.addEventListener('click', function () {
        dataConnection.send({msg: "FUCK EVERYONE"});
    });
});
